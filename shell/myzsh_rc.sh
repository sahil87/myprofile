...
path=($path ~/.rvm/bin . ~/.local/bin $MYPROFILEDIR/bin ~/.yarn/bin ~/.jx/bin /usr/local/go/bin ~/code/bin $GOPATH/bin ~/Android/Sdk/platform-tools ~/Android/Sdk/tools /mnt/files/storage/groovy/bin $GRADLE_PATH)
