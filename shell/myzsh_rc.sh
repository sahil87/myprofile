...
path=($path ~/.rvm/bin . ~/.local/bin $PARENTDIR/bin ~/code/sportscafe/scbuild/bin /usr/local/go/bin $GOPATH/bin ~/Android/Sdk/platform-tools ~/Android/Sdk/tools $GRADLE_PATH)
